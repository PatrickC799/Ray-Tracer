...
int main(int argc, char *argv[])
{
  ...
  for (int i = 0; i< pm->triangle_count; i += 1)
  {
    ...
    float x1 = (pm->vertex[pm->triangle[i][1]].x/pm->vertex[pm->triangle[i][1]].z)*256 + 256.0;
    float y1 = -(pm->vertex[pm->triangle[i][1]].y/pm->vertex[pm->triangle[i][1]].z)*256 + 256.0;
    float x2 = (pm->vertex[pm->triangle[i][2]].x/pm->vertex[pm->triangle[i][2]].z)*256 + 256.0;
    float y2 = -(pm->vertex[pm->triangle[i][2]].y/pm->vertex[pm->triangle[i][2]].z)*256 + 256.0;
